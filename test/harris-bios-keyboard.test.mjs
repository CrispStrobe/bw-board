...
registerBusMemory();
test('BIOS keyboard IRQ translation and two paced INT 16h reads return Enter',()=>{
...
HLT`,0x6000);
    ...
    const board=createHarrisMemoryBoard({enabled:true,rom,romLowAlias:true,intrEnabled:true,ioEnabled:true,interruptDevice:pic,keyboardDevice:keyboard});
