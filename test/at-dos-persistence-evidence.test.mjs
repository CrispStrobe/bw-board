...
// IBM 5170 (AT) firmware is a proprietary, non-redistributable ROM. The ROM-free
...
test('source-bound AT DOS receipts prove write then fresh-remount read without replaying creation',{skip:romGate},()=>{
