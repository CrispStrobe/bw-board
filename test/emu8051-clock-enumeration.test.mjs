...
const METHODS = {
  ...
  checkpointSupport:{ effect: 'forward', call: a => a.checkpointSupport() },
  captureCheckpointState: {effect: 'forward', call: a => a.captureCheckpointState()},
  prepareCheckpointRestore: {effect: 'forward', call: a => a.prepareCheckpointRestore(null)},
