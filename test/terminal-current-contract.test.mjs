...
test('OP/live conversion covers every supported kind, not a four-kind reverse list', () => {
  ...
  for (const id of ['RD', 'RZ', 'RBQ', 'RCQ', 'RL', 'RC', 'RI', 'RE', 'RG', 'RV']) {
  ...
  const nets = [
    net('in', ['V.pos', 'RD.a', 'RZ.a', 'RBQ.a', 'RCQ.a', 'RL.a', 'RC.a', 'E.inp', 'G.inp']),
    ...
    net('ground', ['GND.gnd', 'V.neg', 'D.cathode', 'Z.cathode', 'Q.emitter', 'L.b', 'C.b', 'I.neg',
