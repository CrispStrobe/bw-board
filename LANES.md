...
| --- | --- | --- | --- |
| remote-first fast-lane protocol | `/root/sol_lane_coordination` (Codex, isolated worktree `/mnt/volume1/code/wt/bwb-fast-lane-protocol-sol`) | 2026-09-13, exact base `3fa918756dec4000112646c0bb3f93a904fbf377` | **CLAIM.** Documentation-only scope: the repository-role/protocol/lean-qualification sections above and this row in `LANES.md`. No executable, CI, package, or dependency edits. Coordinate the matching Brickwright Lite protocol update upstream-first; preserve all existing claims and in-flight work. |
