...
| --- | --- | --- | --- |
| explicit non-UIC transient initialization | `/root/zenodo_access_diagnosis` (Codex Sol), worktree `/mnt/volume1/code/wt/bw-board-nonuic-transient-sol` | `lane/nonuic-transient-sol` at exact base `4b40a0ed3ff6977fc75e5d42c1c1e23c47346ea9` | **CLAIM 2026-09-14.** Add an engine-owned atomic time-zero initializer for the already strict grounded static R/C/L/D/V/I/E/G operating-point domain, adopting capacitor voltage and signed inductor current into fresh transient state without changing legacy transient equations. Refuse advanced time, waveform sources, IC/nodeset, conflicts/nonconvergence, floating or indeterminate ideal constraints, and leave state unchanged on every failure. Add deterministic R/C/L positive/negative non-UIC transient proofs against self-authored ngspice. No startup ramp, ASC/ASY parser, MOS/BJT equation, GMIN policy, or unrelated device work. |
