...
| --- | --- | --- | --- |
| bounded transient execution efficiency and deterministic work budgets | `/root/zenodo_access_diagnosis` (Codex Sol), worktree `/mnt/volume1/code/wt/bwb-waveform-efficiency-sol` | 2026-09-14, `lane/waveform-efficiency-sol`, exact base `d25376cb4150335fe3cf28a26e63994b6b96a03f` | **ACTIVE.** Owns measured Board/source-analysis execution efficiency for long and many-source waveform cases, especially fixed Si7li rows 5929 and historical 3525. Preserve interactive-v1 defaults, precision-v1 qualification, current polarity, source/sample intervals, initialization semantics and tolerance contracts. Optimize only state-compatible solve work; otherwise issue deterministic preflight/runtime refusal with measured work evidence. No private oracle/comparator files, importer/GUI directive support, broad budget increase, tolerance waiver, or restricted payload. |
