...
| ZX ULA complete snapshot convergence | Codex immutable-inputs session | `converge/zx-ula-checkpoint`, base `facef91` | CLAIMED 2026-09-09. Preserve keyboard, EAR cursor/level/queue and speaker history through existing Z80 machine save/load; verify detached snapshots and legacy-state behavior before Lite retirement. |
| --- | --- | --- | --- |
