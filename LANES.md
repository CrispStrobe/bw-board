...
| --- | --- | --- | --- |
| z80 code-breakpoint bound convergence | sim2cx (Codex) | `converge/z80-code-bound` from exact `917c9e3c8d40e0594f7fa4776f68648460272d47` | **CLAIM 2026-09-13.** Derive one architectural 16-bit maximum/refusal authority for descriptor, guard, and message; extend existing bounds test with Z80 agreement. Three isolated descriptor/guard/refusal mutants, including wrong-address sensitivity. Excludes machine/checkpoint, write-watch, other targets, workflows, Lite, and shared docs. |
