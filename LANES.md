...
| --- | --- | --- | --- |
| standard-parts corpus evidence update | `/root/sol_lane_coordination` (Codex Sol), isolated `/mnt/volume1/code/wt/bwb-corpus-programme-facts-sol` | 2026-09-13, exact base `8b85437` | **CLAIM.** Docs-only factual update to `docs/STANDARD-PARTS-PROGRAMME.md`: link the private 93-ID source catalog; record the 81 modern + 7 legacy date-bounded KiCad reconstruction and separate five-file EAGLE replacement; record the fixed 85-body/255-case/1,785-finite-comparison ADI controlled-E qualification and missing full artifact; distinguish public native R/C/V/I operating-point support from private controlled-E harness evidence. Envelope is that document and this row only. No corpus payload, solver/importer/package code, acquisition, CI, pins, or public redistribution decision. Existing bwlang parts/oracle implementation and the private recovered-import harness remain separately owned. |
