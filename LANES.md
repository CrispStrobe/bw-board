...
| --- | --- | --- | --- |
| bounded transient execution efficiency and deterministic work budgets | `/root/zenodo_access_diagnosis` (Codex Sol), worktree `/mnt/volume1/code/wt/bwb-waveform-efficiency-sol` | 2026-09-14, `lane/waveform-efficiency-sol`, exact base `d25376cb4150335fe3cf28a26e63994b6b96a03f` | **ACTIVE follow-up.** Landed algebraic-direct implementation `7bb750b83bda168863372a945fa9248d8ba1e5ab` / closure `b45a7ce9874332602e89d10a5e88c12c3c71adcc`; CI `34868399758` and Harris `34868399744` succeeded. The follow-up is limited to observable-aware local truncation error control for the measured Si7li train5100 RL/SINE precision boundary, with unchanged tolerances/current conventions and analytic plus corpus regression evidence. Existing algebraic-direct behavior and honest adaptive budget refusals remain in scope for regression only. |
