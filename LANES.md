...
| --- | --- | --- | --- |
| m6502 code-breakpoint bound convergence | sim2cx (Codex) | `converge/m6502-code-bound` from exact `17215024524d612acace8e122a1baf13d89b5e53` | **CLAIM 2026-09-13.** Derive one architectural 16-bit maximum for the run-to descriptor, code-breakpoint guard, and refusal text; extend existing `test/code-breakpoint-bounds.test.mjs` with advertised/accepted/first-successor/named agreement. Three isolated caller-consequence mutations. Excludes machine/checkpoint, write-watch, other targets, workflows, Lite, and shared docs. |
