      ...
      000003 02 00 62         [24]  300 	ljmp	_main
                                    ...
                                    308 ;------------------------------------------------------------
                                    309 ;	00_hello/hello.c:21: void main(void) {
                                    310 ;	-----------------------------------------
                                    311 ;	 function main
                                    312 ;	-----------------------------------------
      000062                        313 _main:
                           ...
                           000000   321 	ar0 = 0x00
      000062                        322 00102$:
                                    323 ;	00_hello/hello.c:24: P2_0 = 0;
                                    324 ;	assignBit
      000062 C2 A0            [12]  325 	clr	_P2_0
                                    326 ;	00_hello/hello.c:25: delay(30000);
      000064 90 75 30         [24]  327 	mov	dptr,#0x7530
      000067 12 00 74         [24]  328 	lcall	_delay
                                    329 ;	00_hello/hello.c:26: P2_0 = 1;
                                    330 ;	assignBit
      00006A D2 A0            [12]  331 	setb	_P2_0
                                    332 ;	00_hello/hello.c:27: delay(30000);
      00006C 90 75 30         [24]  333 	mov	dptr,#0x7530
      00006F 12 00 74         [24]  334 	lcall	_delay
                                    335 ;	00_hello/hello.c:29: }
      000072 80 EE            [24]  336 	sjmp	00102$
                                    337 ;------------------------------------------------------------
                                    338 ;Allocation info for local variables in function 'delay'
                                    339 ;------------------------------------------------------------
                                    340 ;t                         Allocated to registers 
                                    341 ;------------------------------------------------------------
                                    342 ;	00_hello/hello.c:31: static void delay(unsigned int t) {
                                    343 ;	-----------------------------------------
                                    344 ;	 function delay
                                    345 ;	-----------------------------------------
      000074                        346 _delay:
      000074 AE 82            [24]  347 	mov	r6,dpl
      000076 AF 83            [24]  348 	mov	r7,dph
                                    349 ;	00_hello/hello.c:32: while (t--)
      000078                        350 00101$:
      000078 8E 04            [24]  351 	mov	ar4,r6
      00007A 8F 05            [24]  352 	mov	ar5,r7
      00007C 1E               [12]  353 	dec	r6
      00007D BE FF 01         [24]  354 	cjne	r6,#0xff,00111$
      000080 1F               [12]  355 	dec	r7
      000081                        356 00111$:
      000081 EC               [12]  357 	mov	a,r4
      000082 4D               [12]  358 	orl	a,r5
      000083 70 F3            [24]  359 	jnz	00101$
                                    360 ;	00_hello/hello.c:34: }
      000085 22               [24]  361 	ret
                                    362 	.area CSEG    (CODE)
                                    363 	.area CONST   (CODE)
                                    364 	.area XINIT   (CODE)
