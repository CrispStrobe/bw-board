...
function install(w){
  ...
  const code=[0xb8,0x10,0,0x8e,0xd0,0x8e,0xd8,0x8e,0xc0,0xbc,0,8,
    0xb8,0x18,0,0x0f,0,0xd8,0x66,0xb8,0,0x70,0,0,0x0f,0x22,0xd8,
...
const expected={halted:true,cs:8,eip:0x102a,tr:0x18,cr3:0x7000,result:0x22222222,oldBusy:11,newBusy:9,backlink:0x18};
