...
const mutations=[
    ...
    ...[
        ...
        ['missing present-bank count','if(present[b])memory_pass_work[4]++;','(void)present[b];'],
        ['missing changed-bank count','if(bank_changed[b]){*changed=1;memory_pass_work[5]++;}','if(bank_changed[b])*changed=1;'],
