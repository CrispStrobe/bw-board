...
export const INPUTS = [
    {
        ...
        gates: ['test/harris-native-admitted-graph.test.mjs', 'test/harris-native-bus-sequencer.test.mjs', 'test/harris-native-bus-circuit.test.mjs', 'test/harris-native-bus-admission.test.mjs', 'test/harris-native-evaluators.test.mjs',
