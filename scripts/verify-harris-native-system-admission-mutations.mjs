...
const mutations=[
    ...
    {name:'admitted runtime bypasses its missing grant',pattern:'graph-only admission',file:'memory-circuit.c',
        from:'if(c[31]&&admitted_memory_context!=c){fault[0]=4;fault[1]=10;return 4;}',
        to:'(void)admitted_memory_context;'},
