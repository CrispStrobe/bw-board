/** Compare bounded ring-0 LAR/LSL and selector setup with pinned PCjs. */
...
const localPathspecs = [
  "scripts/compare-pcjs-i80386-lar-lsl.mjs",
...
const sources = ["./compare-pcjs-i80386-lar-lsl.mjs", "../src/experimental/i80386.js"];
...
function install(write) {
  ...
  put(write, 0x1000, [
    ...
    0xb8,0x0c,0,0x8e,0xd8,
    0xb8,0x20,0,0x66,0x0f,0x02,0xd8,0x66,0x0f,0x03,0xf8,0xf4,
  ]);
}
...
function runPCjs() {
  ...
  return result({eax:cpu.regEAX,ebx:cpu.regEBX,ecx:cpu.regECX,edi:cpu.regEDI,ds:cpu.getDS(),segDS:cpu.segDS,segLDT:cpu.segLDT,segTSS:cpu.segTSS,getCS:()=>cpu.getCS(),getIP:()=>cpu.getIP(),intFlags:cpu.intFlags}, (a)=>bus.getByteDirect(a));
}
